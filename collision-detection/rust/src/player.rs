...
use godot::engine::{InputEvent, IArea2D, Area2D};
use godot::prelude::*;
...
impl Player {
    ...
    #[func]
    fn did_collide_with(_area: Gd<Area2D>) {
        godot_print!("colliding with object");
    }

    #[func]
    fn did_exit_collision(_area: Gd<Area2D>) {
        godot_print!("collision will exit");
    }
